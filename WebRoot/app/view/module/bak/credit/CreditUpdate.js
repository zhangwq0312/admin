Ext.define('app.view.module.credit.CreditUpdate', {
	extend: 'Ext.grid.Panel',
	requires: [
       'app.view.module.credit.CreditUpdateController',
    ],
    
	alias: 'widget.creditUpdate',
	
	uses: ['app.view.module.credit.CreditUpdateToolbar'],
	
	title: '管理员用户',
	controller: 'creditUpdate',
