Ext.define('app.view.module.credit.CreditAwardController', {
	extend : 'Ext.app.ViewController',

	requires : [ 'Ext.window.Toast' ],

	alias : 'controller.creditAward',

	onAddBtn : function(btn, e) {
		var win = this.lookupReference('creditAward_window');
	...
	onChoiceRole : function(btn, e) {
		AppUtil.showChoiceWindow({
			view : this,
			btn : btn,
			mWin : this.lookupReference('creditAward_window'),
			win_title : '选择角色',
