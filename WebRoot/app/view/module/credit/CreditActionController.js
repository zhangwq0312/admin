Ext.define('app.view.module.credit.CreditActionController', {
	extend : 'Ext.app.ViewController',

	requires : [ 'Ext.window.Toast' ],

	alias : 'controller.creditAction',

	onAddBtn : function(btn, e) {
		var win = this.lookupReference('creditAction_window');
	...
	onChoiceRole : function(btn, e) {
		AppUtil.showChoiceWindow({
			view : this,
			btn : btn,
			mWin : this.lookupReference('creditAction_window'),
			win_title : '选择角色',
